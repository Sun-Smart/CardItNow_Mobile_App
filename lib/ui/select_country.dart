      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Text("Select Your Country",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,
        ...
        // padding: EdgeInsets.all(20),
                  ...
                  child: Card(
                    ...
                    color:
                    type == countrytype[index] ? Color( 0xffA8DAB5) : Colors.white,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 30,),
                              Text(countryname[index],style: TextStyle(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              backgroundColor: Color(0xff35fd6f),
