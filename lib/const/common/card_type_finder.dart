...
const Map<CardTypeFinder, Set<List<String>>> cardNumPatterns = {
  CardTypeFinder.visa: {
    ['4'],
  },
  CardTypeFinder.amex: {
  ...
  CardTypeFinder.discover: {
    ['6011'],
    ['644', '649'],
    ['65'],
  },
  CardTypeFinder.mastercard: {
    ['51', '55'],
    ['2221', '2229'],
    ['223', '229'],
    ['23', '26'],
...
CardTypeFinder detectCCType(String ccNumStr) {
  CardTypeFinder cardType = CardTypeFinder.unknown;
  ...
  cardNumPatterns.forEach(
        (CardTypeFinder type, Set<List<String>> patterns) {
...
String cardTypeFunction(var cardNumber){
  var type = detectCCType(cardNumber);
  String card;
  switch (type) {
    case CardTypeFinder.visa:
      card = "VISA";
      break;

    case CardTypeFinder.amex:
      card = "AMEX";
      break;

    case CardTypeFinder.maestro:
      card = "MAESTRO";
      break;
    case CardTypeFinder.mastercard:
      card = "MC";
      break;

    case CardTypeFinder.discover:
      card = "DISC";
      break;

    case CardTypeFinder.dinersclub:
      card = "DCI";
      break;

    case CardTypeFinder.jcb:
      card = "JCB";
      break;
